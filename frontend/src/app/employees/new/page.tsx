...
function NewEmployeePageContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Usando a função da API
      await api.createEmployee(validatedData);
      ...
      if (error instanceof z.ZodError) {
        ...
        setErrors({ general: 'Erro desconhecido ao adicionar funcionário.' });
      }
    } finally {
      setIsLoading(false);
    }
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                maxLength={11}
                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.cpf ? 'border-red-500' : 'border-gray-300'}`}
...
export default NewEmployeePageContent;
